...
def create_data_object(
    ...
    elif (input_sunspec_data["class_name"] == epcpm.sunspecmodel.TableRepeatingBlockReferenceDataPointReference.__name__):
        return create_function_data(
            input_sunspec_data, scale_factor_uuid_map, sunspec_types, staticmodbus_types
        )
    else:
...
def create_function_data_bitfield(
    ...
    # A bitfield would never be a scale factor, so no need to check for uuid in scale_factor_uuid_map.
